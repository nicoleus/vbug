...
# MY FACEBOOK  : Nicoleus Sitorus
# MY YOUTUBE   : adysitorusady
...
${Nico} /    /  \___ \\  ___/\  \__\  \___\  \_/   \/ /_/ \  ___/ - ${Nico}MR.WRECK
/_____ \/____  >\___  >\___  >___  >\_____  /\____ |\___  >
      \/     \/     \/     \/    \/       \/      \/    \/ 
                   [^]SMS GRATISS BY Nicoleus Sitorus[^]
#############################################################################
"
...
function negetgan(){
         ...
         if [[ $okeey =~ "SMS Gratis Telah Dikirim" ]]; then
             ...
             echo -e "${RED}[+] ${NORMAL}gagal kirim nih Laen"
         fi
}
nebanner
